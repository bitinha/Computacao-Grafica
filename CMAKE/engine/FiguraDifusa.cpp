...
FiguraDifusa::FiguraDifusa(float diffuse[3], float specular[3], float emissive[3], float ambient[3], vector<float> pontos, vector<float> normais, vector<float> texCoord)
{
