...
void Spot::ilumina(int i){
	...
	glLightfv(GL_LIGHT0 + i, GL_SPOT_DIRECTION, this->spotDirection);
	
	glLightfv(GL_LIGHT0 + i, GL_SPOT_CUTOFF, &this->angle);
	glLightfv(GL_LIGHT0 + i, GL_SPOT_EXPONENT, &this->exponent);
